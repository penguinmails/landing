...
export type FeaturesTranslations = {
  ...
  "features.inbox-rotation.tabTitle": string;
  "features.inbox-rotation.heading": string;
  "features.inbox-rotation.tagline": string;
  "features.inbox-rotation.tagline2": string;
  "features.inbox-rotation.risk.title": string;
  "features.inbox-rotation.risk.subtitle": string;
  "features.inbox-rotation.risk.description": string;
  "features.inbox-rotation.risk.items": string[];
  "features.inbox-rotation.risk.explanation": string;
  "features.inbox-rotation.risk.solution": string;
  "features.inbox-rotation.benefits.title": string;
  "features.inbox-rotation.benefits.subtitle": string;
  "features.inbox-rotation.benefits.description": string;
  "features.inbox-rotation.benefits.items": string[];
  "features.inbox-rotation.steps.title": string;
  "features.inbox-rotation.steps.intro": string;
  "features.inbox-rotation.steps.description": string;
  "features.inbox-rotation.steps.items": Array<{
    title: string;
    description: string;
  }>;
  "features.inbox-rotation.steps.warmupNote": string;
  "features.inbox-rotation.steps.aiNote": string;
  "features.inbox-rotation.comparison.title": string;
  "features.inbox-rotation.comparison.subtitle": string;
  "features.inbox-rotation.comparison.headers": string[];
  "features.inbox-rotation.comparison.rows": Array<{
    feature: string;
    penguin: string;
    others: string;
  }>;
  "features.inbox-rotation.comparison.footer": string;
  "features.inbox-rotation.balanced.title": string;
  "features.inbox-rotation.balanced.subtitle": string;
  "features.inbox-rotation.balanced.description": string;
  "features.inbox-rotation.balanced.items": string[];
  "features.inbox-rotation.balanced.benefit1": string;
  "features.inbox-rotation.balanced.benefit2": string;
  "features.inbox-rotation.balanced.footer": string;
  "features.inbox-rotation.whatYouGet.title": string;
  "features.inbox-rotation.whatYouGet.subtitle": string;
  "features.inbox-rotation.whatYouGet.description": string;
  "features.inbox-rotation.whatYouGet.items": string[];
  "features.inbox-rotation.whatYouGet.footer": string;
  "features.inbox-rotation.faq.title": string;
  "features.inbox-rotation.faq.items": Array<{
    question: string;
    answer: string;
  }>;
};
